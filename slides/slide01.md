...
2. [実験概要](#実験概要)
3. [教員&TASAの紹介](#教員tasaの紹介)
4. [環境構築](#環境構築)
5. [センサを使ってみよう](#センサを使ってみよう)
6. [超音波距離センサの使い方](#超音波距離センサの使い方)
7. [心拍センサの使い方](#心拍センサの使い方)
8. [カラーセンサの使い方](#カラーセンサの使い方)
9. [チャレンジ](#チャレンジ)
...
小レポート内容：下記項目について写真や図などを入れ、1-2ページでまとめる
- センサ技術が使用されている分野ついて
- データビジュアライゼーションについて
- 開発環境と使用機材について
...
Cドライブ直下に「**meisei-exb2026**」フォルダを作成し、そこに保存しましょう。
